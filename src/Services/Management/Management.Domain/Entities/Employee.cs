...
public class Employee : Entity
{
    ...
    private Employee(string leader, string employeeCode, string name, string surname, string? personIdentifier,
        Guid? accountId)
    {
        Leader = leader; 
    ...
    private Employee(int id, string leader, int departmentId, Guid? accountId, string employeeCode, string name, string surname, DateTime birthday,
    ...
    public static Employee Create(int departmentId, string leader, string employeeCode, string name, string surname, DateTime birthday,
        string? personIdentifier, CommunicationData communicationData)
    {
        return new Employee(departmentId, leader, employeeCode, name, surname, birthday, personIdentifier, communicationData);
    }

    public static Employee Load(int id, string leader, int departmentId, Guid? accountId, string employeeCode, string name, string surname, DateTime birthday,
        string? personIdentifier, CommunicationData communicationData, List<EmployeeContract> contracts,
    ...
    public static Employee Load(string leader, string employeeCode, string name, string surname,
        string? personIdentifier, Guid? accountId)
    {
        return new Employee(leader, employeeCode, name, surname, personIdentifier, accountId);
    }
