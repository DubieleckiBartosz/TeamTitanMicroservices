...
public class UpdatePaymentMonthDayHandlerTests : CommandHandlerBaseTests<UpdatePaymentMonthDayHandler, UpdatePaymentMonthDayCommand, Unit>
{
    [Fact]
    public async Task Should_Throw_NotFoundException_When_Contract_Not_Found()
    {
        var command = Fixture.GetUpdatePaymentMonthDayCommand();
    ...
    [Fact]
    public async Task Should_Call_CompleteAsync_Method_When_Payment_Month_Day_Updated()
    {
        var command = Fixture.GetUpdatePaymentMonthDayCommand();
