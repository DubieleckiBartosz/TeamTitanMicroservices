...
public class UpdateSettlementTypeHandlerTests : CommandHandlerBaseTests<UpdateSettlementTypeHandler, UpdateSettlementTypeCommand, Unit>
{
    [Fact]
    public async Task Should_Throw_NotFoundException_When_Contract_Not_Found()
    {
        var command = Fixture.GetUpdateSettlementTypeCommand();
    ...
    [Fact]
    public async Task Should_Call_CompleteAsync_Method_When_Settlement_Type_Updated()
    {
        var command = Fixture.GetUpdateSettlementTypeCommand();
