...
public class ResponseStrings
{
    ...
    public const string SentLinkResetTokenSuccess = "An email was sent with a link to reset the password.";
    public const string PasswordChangedSuccess = "The password has been changed, please log in.";
}