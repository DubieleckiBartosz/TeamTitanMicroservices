...
SCRIPTS[3]="/opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P sql123456(!) -d master -i Calculator-create-db.sql" 
SCRIPTS[4]="/opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P sql123456(!) -d TeamTitanCalculator -i Calculator-create-tables.sql" 
SCRIPTS[5]="/opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P sql123456(!) -d TeamTitanCalculator -i Calculator-create-storedProcedures.sql" 
SCRIPTS[6]="/opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P sql123456(!) -d master -i Background-create-db.sql" 
